...
def jovian_o6_order03_internal_xyz( x_rj, y_rj, z_rj):
    ...
    #
    # Version Info:
    #  Last update of this file: 2022-07-06 11:22:53.961013 by user wilsonr. 
    ...
    r_scale = np.float64(71492.000000)/np.float64(71372.000000)
    x_in = x_in * r_scale
    y_in = y_in * r_scale
    z_in = z_in * r_scale
